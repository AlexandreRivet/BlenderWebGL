...
OBJ.prototype.parse = function(text)
{
    var object, objects = [];
    ...
    for ( var i = 0, l = objects.length; i < l; i ++ ) {
        ...
        var mesh = new THREE.Mesh( new THREE.Geometry().fromBufferGeometry(buffergeometry), material );
...
OBJ.prototype.export = function(object)
{
    var output = '';
